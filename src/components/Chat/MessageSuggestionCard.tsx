    ...
    >
      ...
      <div className="p-3 pb-2">
        <div className="flex items-center justify-between mb-2">
          <div
            className={`flex items-center gap-2 px-2 py-1 rounded-full text-xs font-medium border ${getTypeColor()}`}
          >
            {getTypeIcon()}
            {getTypeName()}
          </div>
          <div className="text-xs text-gray-500">Fase {suggestion.phase}</div>
        </div>
      ...
      <div className="px-3 pb-2">
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <div className="text-xs text-gray-600">{suggestion.strategy}</div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        ...
        <div className="text-xs text-gray-500">{suggestions.length} opciones</div>
      </div>
