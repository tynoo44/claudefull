...
import { Users, Plus, Grid3X3, List, Filter, Download, BarChart3, Search, X, ChevronDown, MapPin, Activity } from 'lucide-react';
        ...
        {showFilters && (
          <div className="flex items-center gap-2 flex-1">
            ...
            <div className="relative group">
              <button className={`px-3 py-1.5 rounded-lg border transition-all flex items-center gap-2 text-sm ${
                selectedStatus !== 'all'
                ...
                <span className="whitespace-nowrap">{selectedStatus === 'all' ? 'Estado' : selectedStatus}</span>
            ...
            <div className="relative group">
              <button className={`px-3 py-1.5 rounded-lg border transition-all flex items-center gap-2 text-sm ${
                ...
                <span className="whitespace-nowrap">{selectedProcedence === 'all' ? 'Origen' : selectedProcedence}</span>
                <ChevronDown className="w-3 h-3" />
              </button>
