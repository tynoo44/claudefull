...
- **mcp**supabase**execute_sql**: Database queries and schema analysis
- **mcp**supabase**list_tables**: Table structure inspection
- **mcp**supabase**get_project**: Project configuration review
