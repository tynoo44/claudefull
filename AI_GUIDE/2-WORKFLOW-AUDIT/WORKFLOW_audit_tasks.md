...
- **mcp**supabase\*\*\*\*: Database queries, schema analysis, data inspection
- **mcp**taskmaster-ai\*\*\*\*: Task tracking and progress logging
- **mcp**memory\*\*\*\*: Context retention during investigation
